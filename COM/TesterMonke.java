...
public class TesterMonke extends Troop {
    ...
    public TesterMonke(Vektor location, boolean isFrendly) throws IOException {
        super(ImageIO.read(new File("TeseterMonke.png")), SPEED, DAMAGE, RANGE, COOL, MAXHEATLH, COST, Math.PI/2, location, ANIMATION, MAXHEATLH, isFrendly);
    }
}
